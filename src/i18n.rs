...
pub struct Texts {
    ...
    pub command_help_prefix: &'static str,
    ...
    pub form_help_prefix: &'static str,
    ...
    pub config_editor_command_id_exists: &'static str,
...
pub const ZH_CN: Texts = Texts {
    ...
    settings_title: " 设置 ",
    settings_help: " ↑↓选择  Enter/Space修改/执行  ←→修改  Esc/F2关闭 ",
    settings_language: "界面语言",
    settings_remember_selection: "记住上次选择",
    settings_remember_input: "记住上次输入",
    settings_input_record_limit: "输入记录上限",
    settings_clear_history: "清空历史",
    settings_clear_history_action: "Enter执行",
    settings_on: "开",
    settings_off: "关",
    save_settings_failed_prefix: "保存设置失败：",
    clear_history_failed_prefix: "清空历史失败：",
    config_editor_title: " 配置编辑 ",
    config_editor_help: " ↑↓选择  Enter编辑/打开片段  Ctrl+j换行  Ctrl+n新增  Ctrl+s保存  Esc/F3关闭 ",
    ...
    config_editor_command_id_exists: "命令 ID 已存在：",
...
pub const EN: Texts = Texts {
    ...
    command_help_prefix: "Description: ",
    ...
    settings_help: " ↑↓ select  Enter/Space change/run  ←→ change  Esc/F2 close ",
    ...
    settings_clear_history_action: "press Enter",
    settings_on: "on",
    settings_off: "off",
    save_settings_failed_prefix: "Failed to save settings: ",
    clear_history_failed_prefix: "Failed to clear history: ",
    config_editor_title: " Configuration editor ",
    config_editor_help: " ↑↓ select  Enter edit/open snippet  Ctrl+j newline  Ctrl+n new  Ctrl+s save  Esc/F3 close ",
    ...
    config_editor_danger: "Dangerous command",
    config_editor_template: "Command template",
    config_editor_params: "Parameters",
    config_editor_options: "Options",
    config_editor_save_failed_prefix: "Failed to save config: ",
    config_editor_command_id_exists: "Command ID already exists: ",
    ...
    config_template_property_title: " Snippet properties ",
    ...
    config_template_required_part: "Required snippet",
    config_template_optional_part: "Optional snippet",
};
